...
public abstract class Expr {
    ...
    /** Unary operator: natural log*/      public static final int LN   = 108;
    /** Unary operator: natural log*/      public static final int LOG   = 109;
    /** Unary operator: negation        */ public static final int NEG   = 110;
    /** Unary operator: rounding  */       public static final int ROUND = 111;
    /** Unary operator: sine      */       public static final int SIN   = 112;
    /** Unary operator: square root */     public static final int SQRT  = 113;
    /** Unary operator: tangent */         public static final int TAN   = 114;
...
class BinaryExpr extends Expr {
	...
	case LOG:   return Math.log(arg1) / Math.log(arg0);
